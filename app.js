...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('TheWildeBarber.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('TheWildeBarber.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('TheWildeBarber.xml', function (err, result) {
            ...
            jsToXmlFile('TheWildeBarber.xml', result, function(err){
